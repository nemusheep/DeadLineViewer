#############################################################################
# Makefile for building: DL.app/Contents/MacOS/DL
# Generated by qmake (3.1) (Qt 6.9.0)
# Project:  DL.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile DL.pro
#############################################################################
...
INCPATH       = -I. -I. -I/opt/homebrew/lib/QtWebEngineWidgets.framework/Headers -I/opt/homebrew/lib/QtPrintSupport.framework/Headers -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtWebEngineCore.framework/Headers -I/opt/homebrew/lib/QtQuick.framework/Headers -I/opt/homebrew/lib/QtOpenGL.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtQmlMeta.framework/Headers -I/opt/homebrew/lib/QtQmlModels.framework/Headers -I/opt/homebrew/lib/QtQmlWorkerScript.framework/Headers -I/opt/homebrew/lib/QtWebChannel.framework/Headers -I/opt/homebrew/lib/QtQml.framework/Headers -I/opt/homebrew/lib/QtNetwork.framework/Headers -I/opt/homebrew/include -I/opt/homebrew/include/QtQmlIntegration -I/opt/homebrew/lib/QtPositioning.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I. -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/OpenGL.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/System/Library/Frameworks/AGL.framework/Headers -I/opt/homebrew/share/qt/mkspecs/macx-clang -F/opt/homebrew/lib
...
COMPRESS      = gzip -9f
DISTNAME      = DL1.0.0
DISTDIR = /Users/takutotsuji/qtPractice/DL/.tmp/DL1.0.0
...
SOURCES       = DL.cpp qrc_resources.cpp
OBJECTS       = DL.o \
		qrc_resources.o
...
EXPORT__PRO_FILE_ = /Users/takutotsuji/qtPractice/DL/DL.pro
...
DL.app/Contents/MacOS/DL:  $(OBJECTS)  
	@test -d DL.app/Contents/MacOS/ || mkdir -p DL.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: DL.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.9.0/share/qt/mkspecs/common/macx.conf \
...
DL.app/Contents/PkgInfo: 
	@test -d DL.app/Contents || mkdir -p DL.app/Contents
	@$(DEL_FILE) DL.app/Contents/PkgInfo
	@echo "APPL????" > DL.app/Contents/PkgInfo
DL.app/Contents/Info.plist: 
	@test -d DL.app/Contents || mkdir -p DL.app/Contents
	@$(DEL_FILE) DL.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.DL,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.DL,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,DL,g" -e "s,@LIBRARY@,DL,g" -e "s,\$${EXECUTABLE_NAME},DL,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >DL.app/Contents/Info.plist

all: Makefile \
		DL.app/Contents/PkgInfo \
		DL.app/Contents/Info.plist DL.app/Contents/MacOS/DL
...
distdir: FORCE
	...
	$(COPY_FILE) --parents DL.cpp $(DISTDIR)/
...
DL.o: DL.cpp /opt/homebrew/lib/QtWidgets.framework/Headers/QApplication \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DL.o DL.cpp
